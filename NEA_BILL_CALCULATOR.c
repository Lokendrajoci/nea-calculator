...
if(kilowatt_per_hour>0 &&kilowatt_per_hour<=20){
    ...
    amount=75+(20*3)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.5;
    printf("Rs = %f",amount);
}
else if(kilowatt_per_hour>100 && kilowatt_per_hour<=250){
    amount=100+(20*3)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.50;
    printf("Rs= %f",amount);
}
else{
    amount=150+(20*3)+(10*6.5)+(20*8)+(200*9.5)+(kilowatt_per_hour-250)*11;
    printf("Rs= %f",amount);
}
}
/*                         ********************************************************                         */
...
if(kilowatt_per_hour>0 &&kilowatt_per_hour<=20){
    ...
    amount=100+(20*4)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.5;
    printf("Rs = %f",amount);
}
else if(kilowatt_per_hour>100 && kilowatt_per_hour<=250){
    amount=125+(20*4)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.50;
    printf("Rs= %f",amount);
}
else{
    amount=175+(20*4)+(10*6.5)+(20*8)+(200*9.5)+(kilowatt_per_hour-250)*11;
    printf("Rs= %f",amount);
}
}
...
if(kilowatt_per_hour>0 &&kilowatt_per_hour<=20){
    ...
    amount=100+(20*5)+(10*6.5)+(kilowatt_per_hour-30)*8;
    printf("Rs = %f",amount);
}
else if(kilowatt_per_hour>50 && kilowatt_per_hour<=100){
    amount=125+(20*5)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.5;
    printf("Rs = %f",amount);
}
else if(kilowatt_per_hour>100 && kilowatt_per_hour<=250){
    amount=150+(20*5)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.50;
    printf("Rs= %f",amount);
}
else{
    amount=200+(20*5)+(10*6.5)+(20*8)+(200*9.5)+(kilowatt_per_hour-250)*11;
    printf("Rs= %f",amount);
}
}
/*       ************************************************************* ***************** */
...
if(kilowatt_per_hour>0 &&kilowatt_per_hour<=20){
    ...
    amount=125+(20*6)+(10*6.5)+(kilowatt_per_hour-30)*8;
    printf("Rs = %f",amount);
}
else if(kilowatt_per_hour>50 && kilowatt_per_hour<=100){
    amount=150+(20*6)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.5;
    printf("Rs = %f",amount);
}
else if(kilowatt_per_hour>100 && kilowatt_per_hour<=250){
    amount=200+(20*6)+(10*6.5)+(20*8)+(kilowatt_per_hour-50)*9.50;
    printf("Rs= %f",amount);
}
else{
    amount=250+(20*6)+(10*6.5)+(20*8)+(200*9.5)+(kilowatt_per_hour-250)*11;
    printf("Rs= %f",amount);
}
}
return 0;
